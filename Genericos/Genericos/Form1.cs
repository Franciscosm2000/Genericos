    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            Generico_Restriccion<Director> dir = new Generico_Restriccion<Director>(tamano);

            foreach (String ob in listBox1.Items)
            {
                dir.add(new Director (Double.Parse(ob.ToString())));
            }

            for (int i = 0; i < tamano; i++)
            {
                Director dat = dir.getEmpleado(i);
                double sal = dat.getSalario();
                listBox2.Items.Add(sal);
            }
